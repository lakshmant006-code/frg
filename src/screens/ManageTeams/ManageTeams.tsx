...
export const ManageTeams = (): JSX.Element => {
      ...
      <div className="flex">
        ...
        <main className="flex-1 p-8">
          <AnimatedPage>
            ...
            <p className="text-gray-600 mb-8">Manage your team list and create new teams</p>
                ...
                <div className="bg-white p-6 rounded-lg shadow h-full">
                  <div className="flex flex-col h-full">
                    <div className="flex-1">
                      <h3 className="text-xl font-semibold mb-2">Team List</h3>
                ...
                <div className="bg-white p-6 rounded-lg shadow h-full">
                  <div className="flex flex-col h-full">
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600">Add a new team to the system.</p>
                    </div>
                    <div className="flex justify-center mt-4 pt-4 border-t">
                      <button 
                        className="bg-black text-white px-4 py-2 rounded w-full"
